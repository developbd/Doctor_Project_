<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SPAdmin.Master" AutoEventWireup="true" CodeBehind="DoctorVerify.aspx.cs" Inherits="doctor.Admin.DoctorVerify" %>
        ...
        <div class="tg-dashboardfavoritlisting">
            <div class="tg-dashboardbox">
                <div class="tg-dashboardboxtitle">
                    <h2>Doctor Verifycation Settings</h2>
                </div>
                                                ...
                                                <ItemTemplate>
                                                    <li>
                                                        ...
                                                        <div class="tg-btnaction">
                                                            ...
                                                            <asp:LinkButton ID="btnAutority" CssClass="btnBlack" runat="server" CommandArgument='<%# Eval ("ID") %>' OnCommand="btnAutority_Command">Authorise</asp:LinkButton>
                                                            <asp:LinkButton ID="btnVerify" CssClass="btnBlack" runat="server" CommandArgument='<%# Eval ("ID") %>' OnCommand="btnVerify_Command">Verify</asp:LinkButton>
                                                            <asp:LinkButton ID="btnLoginPermit" CssClass="btnBlack" runat="server" CommandArgument='<%# Eval ("ID") %>' OnCommand="btnLoginPermit_Command">Log Permit</asp:LinkButton>
                                                            <a class="btnBlack" href='<%# Eval("DoctorID","DoctorAdd.aspx?Edit={0}") %>'>View/Edit</a>
                                                        </div>
                                                    </li>
                                                </ItemTemplate>
                                            </asp:TemplateField>
