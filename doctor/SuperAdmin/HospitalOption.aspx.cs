...
{
    public partial class HospitalOption : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select * from HospitalRegistation order by ID", con);
        ...
        protected void btnScarchCountry_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from HospitalRegistation where Country='" + ddlCountry.SelectedItem.ToString() + "' and Division='" + ddlDvision.SelectedItem.ToString() + "' and District='" + ddlDistrict.SelectedItem.ToString() + "' and Upazilla='" + ddlUpazila.SelectedItem.ToString() + "' order by ID", con);
                SqlDataReader dr = cmd.ExecuteReader();
                GridView1.DataSource = dr;
                GridView1.DataBind();
                con.Close();
        ...
        protected void btnScarchRegistationNumber_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from HospitalRegistation where RegistationNumber='" + txtDoctorRegistationNumber.Text + "' order by ID", con);
                SqlDataReader dr = cmd.ExecuteReader();
                GridView1.DataSource = dr;
                GridView1.DataBind();
                con.Close();
        ...
        protected void btnScarchDocetorFullname_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from HospitalRegistation where PersonalFullname LIKE '%" + txtDoctorFullName.Text + "%' order by ID", con);
                SqlDataReader dr = cmd.ExecuteReader();
                GridView1.DataSource = dr;
                GridView1.DataBind();
                con.Close();
        ...
        protected void btnScarchVerify_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from HospitalRegistation where Verify='" + ddlverify.SelectedValue.ToString() + "' order by ID", con);
                SqlDataReader dr = cmd.ExecuteReader();
                GridView1.DataSource = dr;
                GridView1.DataBind();
                con.Close();
        ...
        protected void btnScarchAuthority_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from HospitalRegistation where Authority='" + ddlAuthority.SelectedValue.ToString() + "' order by ID", con);
                SqlDataReader dr = cmd.ExecuteReader();
                GridView1.DataSource = dr;
                GridView1.DataBind();
                con.Close();
        ...
        protected void btnScarchLoginParmit_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from HospitalRegistation where LoginParmit='" + ddlLoginParmit.SelectedValue.ToString() + "' order by ID", con);
                SqlDataReader dr = cmd.ExecuteReader();
                GridView1.DataSource = dr;
                GridView1.DataBind();
                con.Close();
        ...
        protected void btnAutority_Command(object sender, CommandEventArgs e)
        {
            ...
            Check chk = new Check();
            string Authority = chk.stringCheck("select Authority from HospitalRegistation where ID=" + ID + "");
            ...
            if (Authority == "TRUE")
            {
                ...
                rn.ResultDate = 5;
                cmd.CommandText = "update HospitalRegistation set Authority='" + rn.RandomStringNumber("Authority") + "' where ID=" + ID + "";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            ...
            {
                cmd.CommandText = "update HospitalRegistation set Authority='TRUE' where ID=" + ID + "";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            ...
            con.Open();
            SqlCommand cmd2 = new SqlCommand("select * from HospitalRegistation where ID=" + ID, con);
        ...
        protected void btnVerify_Command(object sender, CommandEventArgs e)
        {
            int ID = Convert.ToInt32(e.CommandArgument);
            Check chk = new Check();
            string Verify = chk.stringCheck("select Verify from HospitalRegistation where ID=" + ID + "");
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            if (Verify == "TRUE")
            {
                cmd.CommandText = "update HospitalRegistation set Verify='FALSE' where ID=" + ID + "";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            ...
            {
                cmd.CommandText = "update HospitalRegistation set Verify='TRUE' where ID=" + ID + "";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        protected void btnLoginPermit_Command(object sender, CommandEventArgs e)
        {
            int ID = Convert.ToInt32(e.CommandArgument);
            Check chk = new Check();
            string LoginParmit = chk.stringCheck("select LoginParmit from HospitalRegistation where ID=" + ID + "");
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            if (LoginParmit == "TRUE")
            {
                cmd.CommandText = "update HospitalRegistation set LoginParmit='FALSE' where ID=" + ID + "";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            ...
            {
                cmd.CommandText = "update HospitalRegistation set LoginParmit='TRUE' where ID=" + ID + "";
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        protected void btnDelete_Command(object sender, CommandEventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            cmd.CommandText = "delete from HospitalRegistation where ID="+ID;
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
            con.Open();
            SqlCommand cmd2 = new SqlCommand("select * from HospitalRegistation",con);
            SqlDataReader dr = cmd2.ExecuteReader();
            GridView1.DataSource = dr;
            GridView1.DataBind();
            con.Close();
