<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin/SPAdmin.Master" AutoEventWireup="true" CodeBehind="DoctorAdd.aspx.cs" Inherits="doctor.Admin.DoctorAdd" %>
    ...
    <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 pull-right">
        ...
        <div class="tg-dashboardbox">
            ...
            <div class="tg-box tg-languages tg-uiicons">
                <div class="row tg-rowmargin">
                    <div class="col-md-2 col-sm-4 col-xs-12 tg-columnpadding">
                        <asp:CheckBox ID="chkAuthority" runat="server" /> Authority
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-12 tg-columnpadding">
                        <asp:CheckBox ID="chkLoginPermit"  runat="server" /> Login Parmit
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-12 tg-columnpadding">
                        <asp:CheckBox ID="chkVerify"  runat="server" /> Virify
                    </div>
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 tg-columnpadding">
                                <div class="form-group tg-formgroup">
                                    ...
                                    <asp:Button ID="btnUpdate" runat="server" OnClick="btnUpdate_Click" CssClass="tg-btn tg-btn-lg" Text="Update" />
                                </div>
                            </div>
                ...
                <ul class="tg-threecolumns tg-liststyledot">
                    <a>
                        <asp:Label ID="lblResult" runat="server"></asp:Label></a>
